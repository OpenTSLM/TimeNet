...
- monotonic ints (`chunk_idx`, `chunk_offset0`, `chunk_offset1`) -> DELTA_BINARY_PACKED.
- bounded categoricals (`spec_type`, `channel`, `view`, `key`, `annotation_type`, `label`, `chunk_file`)
  -> dictionary + RLE.
