...
A read never runs connector code. Against a local registry, `load` can build a missing dataset from
an installed connector, then read it (see [Build & publish](build.md)).
