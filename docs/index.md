...
[registry](registry.md). TimeF keeps its relational control plane in DuckDB and stores signal values
in either Parquet or Zarr. The [client](client.md) reads the manifest from the registry and loads
the data.
