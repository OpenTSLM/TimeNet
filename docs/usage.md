...
- `TimeNet().download("org/name")` returns the local TimeF version directory. Its control plane is
  one DuckDB database. Its values plane is Parquet or Zarr, as recorded in the manifest.
