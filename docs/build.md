...
Build turns a [connector](connectors.md)'s raw source into a stored TimeF version. A version contains
`manifest.json`, `control.duckdb`, and a Parquet or Zarr values plane. TimeNet writes the version
