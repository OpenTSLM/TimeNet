...
class ValueEncoding(StrEnum):
    ...
    name does not exist. :mod:`timenet.parquet.encodings` translates in both directions.
    """
...
def encoding_for_cardinality(distinct: int, *, dtype: str = "float32") -> ValueEncoding:
    ...
    from timenet.parquet.encodings import byte_stream_split_supported  # noqa: PLC0415
