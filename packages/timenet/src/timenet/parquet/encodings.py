...
(see :mod:`timenet.parquet.value_encoding`). This module converts that choice into pyarrow write
...
from timenet.parquet.config import DEFAULT_PARQUET_COMPRESSION_LEVEL
