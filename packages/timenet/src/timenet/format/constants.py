...
# PART_INDEX_DIGITS sets how many digits pad the shard numbers. Lexical order matches numeric order
# only while the count fits that width, so part_path() refuses any index past the ceiling.
PART_INDEX_DIGITS = 8
