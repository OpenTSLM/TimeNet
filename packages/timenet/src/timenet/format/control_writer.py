...
from timenet.format.annotation_codec import VALUE_COLUMNS, encode_annotation_value
from timenet.format.duckdb import connect_control, create_control_schema, transaction
from timenet.format.task_codec import PAYLOAD_COLUMNS, encode_span, encode_target, encode_task_payload
...
_CONTENT_COLUMNS = ("content_key", "content_id", "name", *VALUE_COLUMNS, "unit", "metadata")
_OCCURRENCE_COLUMNS = (
    "occurrence_key",
    "occurrence_id",
    "content_key",
