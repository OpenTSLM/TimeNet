...
Version `2.0.0` of this dataset is the TimeNet 0.11 model, in which every signal has exactly one
owning record. Version `1.0.0` built one record per question and shared a metric's series between
...
question-to-series references and **34,972,881** values *(measured)*. In the TimeNet 0.11 model a
