...
from timenet.types import Annotation, InputModality, TSGenerationTask
...
class VerbalTsConnector(BaseConnector[VerbalTsComponent]):
    ...
    def download(self, cache_dir: Path) -> list[VerbalTsComponent]:  # noqa: PLR6301 - BaseConnector override
        ...
        Cached files and new gdown downloads are checked against pinned byte counts and SHA-256.
        ...
        Raises:
            TimeNetDownloadError: If gdown fails to fetch a file.
        """
